...
Sales Orders - Examine Catalog
    ...
    Wait Until Element Is Visible    xpath:/html/body/div[1]/div/div[5]/div/div[7]/div/div[1]/div/div[3]/div[1]/div[2]/div/div/div/span/table/tbody/tr[1]/td/div/ul/li/ul/li[1]/ul/li[1]/ul/li[3]/a     timeout=45s   #CLICK 1PLAY
    Click Element     xpath:/html/body/div[1]/div/div[5]/div/div[7]/div/div[1]/div/div[3]/div[1]/div[2]/div/div/div/span/table/tbody/tr[1]/td/div/ul/li/ul/li[1]/ul/li[1]/ul/li[3]/a
    

    Sleep    5S   #CLICK SIGUIENTE
    ...
    Sleep    10s   #PROMOCION 
    Click Element    xpath:/html/body/div[1]/div/div[5]/div/div[7]/div/div[1]/div/div[3]/div[2]/div[3]/div/div/div/form/span/div/div[3]/div/div/div[3]/div[3]/div/table/tbody/tr[4]/td[2]
...
Copy Past
    ...
    ${idActividad}    Get Value    xpath://*[@id="a_2"]/div/table/tbody/tr[3]/td[3]/div/input
    Open Browser    https://www.google.com    chrome
    input Text     xpath://*[@id="APjFqb"]  ${idActividad}     Chrome
    Sleep    30s
